...
| HB-34 | humanlint conformance should be expressed as levels `HL0` through `HL5` rather than a binary adoption claim. | Proposed doctrine | `docs/agent-native-standard.md`, `agent/standard-version.toml` |
