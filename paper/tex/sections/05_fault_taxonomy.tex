...
The v0.6.0 coverage release turns the source material behind this taxonomy into
...
green means deterministic Jankurai control plus proof/report evidence, yellow
means a named control exists but still needs fixture-backed evidence, and red
means the issue is tracked but not yet controlled.
