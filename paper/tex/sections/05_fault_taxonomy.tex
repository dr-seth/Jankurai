...
\centering
\scriptsize
\caption{TLR RPN share. TLR means Top-Level Risk; shares are computed from Table~\ref{tab:fault-taxonomy}.}
\label{tab:tlr-bars}
\begin{tabularx}{\columnwidth}{L{0.28\columnwidth} L{0.16\columnwidth} Y}
\toprule
\textbf{TLR bucket} & \textbf{RPN share} & \textbf{Relative weight} \\
\midrule
Security & 32\% & \rule{2.6cm}{0.55em} \\
Business truth & 20\% & \rule{1.6cm}{0.55em} \\
Contracts/data & 13\% & \rule{1.0cm}{0.55em} \\
Verification & 13\% & \rule{1.0cm}{0.55em} \\
Entropy & 10\% & \rule{0.8cm}{0.55em} \\
Context/setup & 9\% & \rule{0.7cm}{0.55em} \\
Repair & 3\% & \rule{0.24cm}{0.55em} \\
\bottomrule
\end{tabularx}
\end{table}
