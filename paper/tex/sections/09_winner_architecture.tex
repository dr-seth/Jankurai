...
The Rust/TypeScript/PostgreSQL profile is a reference architecture, not the definition of Jankurai conformance. It gives agents one concrete map, audit one concrete policy, and CI one concrete set of gates for projects that choose this profile. Other profiles can conform when they preserve the same ownership, proof, generated-boundary, security, and witness artifacts.
...
\end{lstlisting}
\end{minipage}
\caption{Ownership spine and agent-control spine for the reference profile.}
